...
Charmed MySQL VM ships a pre-configured and pre-enabled [list of Awesome Alert Rules].
...
## Prerequisites
* A deployed [Charmed MySQL VM operator]
...
[Charmed MySQL VM operator]: /how-to-guides/deploy/lxd
