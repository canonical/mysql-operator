...
# wait until complete
```
Once the model has finished upgrading, you can proceed with the [charm upgrade](/how-to-guides/upgrade/perform-a-minor-upgrade).
...
You can now proceed with the [charm upgrade](/how-to-guides/upgrade/perform-a-minor-upgrade).
