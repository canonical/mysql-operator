...
First, we recommend that you check [the supported interfaces](/t/10250) of the current charm. You have the option to use modern (preferred) or legacy interfaces. 

Most existing charms currently use [ops-lib-pgsql](https://github.com/canonical/ops-lib-pgsql) interface (legacy). 
> See also: [MySQL legacy charm explanation](/t/10788)
...
* To troubleshoot Charmed MySQL, see the [Troubleshooting](/t/11891) page.
* To test the charm, check the [Testing](/t/11770) reference
