...
Once the model has finished upgrading, you can proceed with the [charm upgrade](/how-to/refresh/refresh-single-cluster).
...
You can now proceed with the [charm upgrade](/how-to/refresh/refresh-single-cluster).
