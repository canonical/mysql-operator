...
from s3_helpers import (  # fetch_and_check_existence_of_s3_path,
...
#         logger.info("Checking if unit is waiting to start or restart")
#         if self.charm.unit_peer_data.get("member-state") == "waiting":
...
#         Returns: tuple of (success, error_message)
#         """
#         logger.info(f"Stopping snap={CHARMED_MYSQL_SNAP_NAME}, service {CHARMED_MYSQLD_SERVICE}")
...
#                  "stop"
#              ):
#                 return False, f"Failed to stop service {CHARMED_MYSQLD_SERVICE}"
#         except SnapServiceOperationError as e:
#             error_message = f"Failed to stop service {CHARMED_MYSQLD_SERVICE}"
